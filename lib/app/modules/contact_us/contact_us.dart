  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        FutureBuilder(
            future: controller.ContactUs(),
            builder: (_, s) {
              if (s.connectionState == ConnectionState.waiting)
                return Padding(
                    padding: EdgeInsets.symmetric(
                        horizontal: getScreenWidth(context) * 0.4,
                        vertical: getScreenHeight(context) * 0.4),
                    child:
                        CircularProgressIndicator(color: HexColor('#F4CE14')));
                ...
                return Column(
                    children: controller.contact
                        .map((e) => Stack(children: [
                              ...
                              launchURL(e.Link.contains('http')
                                  ? e.Link
                                  : 'tel:${e.Link}');
                            }))
                        .toList());
