...
class _HomePageState extends State<HomePage> {
        ...
        children: [
          !controller.getIsUserGuest()
              ? IconButton(
                  ...
                  icon: ImageIcon(AssetImage('assets/images/خطوط.png'),
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            ///
                            if (controller.aboutAcademy.isNotEmpty) ...{
                              /// bout Us
                              Container(
                                alignment: Alignment.center,
                                margin: EdgeInsets.only(
                                    top: getScreenWidth(context) >
                                ...
                                child: Row(
                                    ...
                                    children: [
                                      Image.network(
                                          controller.aboutAcademy.last,
                                          errorBuilder: (_, w, c) => Center(
                                            ...
                                            child: Column(children: [
                                              ...
                                              Container(
                                                  ...
                                                  height: getScreenHeight(context) >
                                                      ...
                                                      : getScreenWidth(context) *
                                                          0.175,
                                                  child: Text(controller.myCourses[i].fullname,
                                                      textAlign:
                                                          TextAlign.center,
                                                      style: TextStyle(
                            ...
                            ValueListenableBuilder(
                                valueListenable:
                                    controller.aboutAcademyFreeLessonsState,
                                  ...
                                  if (state == AppViewState.error) {
                                    ...
                                    return Column(children: [
                                      if (controller
                                          ...
                                          /// المسافه بين ال about academy  والفيديو
                                          .aboutAcademyFreeLessons
                                          .isNotEmpty) ...{
                                        getHeightSpace(10),
                                        getTitle(
                                            family: 'Bold',
                                                      ...
                                                      child: Column(children: [
                                                        ...
                                                        Container(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Text(controller.aboutAcademyFreeLessons[i]['fullname'],
                                                                    textAlign: TextAlign
                                                                        .center,
                                                                    style: TextStyle(
                                                                        fontSize: getScreenWidth(context) < getScreenHeight(context)
                                                                            ? getScreenWidth(context) *
                                                                                0.03
                                                                            : getScreenHeight(context) *
                                                                                0.03,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Text('${controller.aboutAcademyFreeLessons[i]['price']} ${getL10(context).egp} ',
                                                                      textAlign: TextAlign
                                                                          .center,
                                                                      style: TextStyle(
                                                                          fontSize: getScreenWidth(context) < getScreenHeight(context)
                                                              ...
                                                              myCourse: controller
                                                                  ...
                                                                  : controller
                                                                      ...
                                                                      .firstWhereOrNull((element) =>
                                                                          element
                                                                              .id ==
                                                                          controller.aboutAcademyFreeLessons[i]
                                                                              [
                                                                              'id']),
                                                            ),
                                                          ),
                            ...
                            ValueListenableBuilder(
                                valueListenable:
                                    controller.aboutAcademyTeachersState,
                                builder: (context, state, child) {
                                  if (state == AppViewState.error) {
                                    return TryAgainErrorWidget(
                                        onclickTryAgain: () {
  ...
  // About Academy
  Row getTitle(BuildContext context, String title, double width, Color color,
      {String? family}) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
  ...
  Subscribe(BuildContext context,int I) {
    showDialog(
      context: context,
          ...
          content: Container(
              ...
              child: Column(
                children: [
                  ...
                  getNormalText(
                    family: 'Bold',
                    "${controller.aboutAcademyFreeLessons[I]['price']} ${getL10(context).egp} ",
                    context,
                    size: 14,
                    color: Colors.white,
                  ),
            ...
            TextButton(
              onPressed: () {
                // Handle the subscription action
                  EnrollCourse(controller.aboutAcademyFreeLessons[I]['id'],_token!);
                  Navigator.pop(context);

              },
              child: Text(

                 getL10(context).subscribeInCourse,
  ...
  Future<void> EnrollCourse(String CourseId ,String TokenId ) async {
    final String url = 'https://salem-mar3y.com/salem_apis/signleteacher/apis.php?function=purchaseCourseUsingWallet&token=$TokenId&id=$CourseId';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if(data['status']=='fail'){
          return  showDialog(context: context, builder:(context) => BackdropFilter(
            filter: ImageFilter.blur(
              sigmaX: 2.0,
              sigmaY: 1.5,
            ),
